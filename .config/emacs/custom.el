...
(custom-set-variables
 ...
 '(package-selected-packages
   '(diminish emojify no-littering counsel beacon consult helpful avy hydra swiper ivy doom-themes rainbow-delimiters which-key auto-package-update comment-dwim-2 minions ws-butler))
 '(tool-bar-mode nil))
;; (custom-set-faces
